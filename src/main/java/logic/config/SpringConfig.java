...
@EnableJpaRepositories("logic.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUsername(environment.getProperty("username_values"));
        return dataSource;
    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("logic.models");//найдет все entity в папке
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("logic.models");
